...
class REDNet(BaseNet):
    def __init__(self, nclass, backbone, aux=False, se_loss=False, norm_layer=nn.BatchNorm2d, **kwargs):
        super(REDNet, self).__init__(nclass, backbone, aux, se_loss, norm_layer=norm_layer, **kwargs)
        ...
        self.conv8 = nn.Sequential(nn.Dropout2d(0.1, False), nn.Conv2d(256, nclass, 1))
