...
'''
    1.  Masks are generated by my own scritps. Mask of all classes in uint8 format means multi hot encoded. 
    2.  This script tries to segment all types of classes.
    3.  Classes are: 1. Background 2. Debris 3. water 4. building 5. building-total 6. vehicle 7. road 8. tree 9. pool 10. sand
...
class Harvey(data.Dataset):
    ...
    # The values associated with the 10 classes
    ...
    color_encoding = OrderedDict([
            ...
            #('pool', (255, 71, 0)), 
            ('pool', (255, 235, 0)),
            ('playground', (120, 120, 70)),
            ('unknown-flooded', (0, 163, 255)),
            ('unknown-non-flooded', (160, 150, 20)),
            ('grass', (4, 250, 7))           
    ])
