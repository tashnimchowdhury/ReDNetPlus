...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.arch == 'psp':
        ...
        model = DUNet(nclass=args.classes, backbone=args.backbone)
    params_list = []
...
def train(train_loader, model, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        intersection, union, target = intersectionAndUnionGPU(final_output, target, args.classes, args.ignore_label)
        if args.multiprocessing_distributed:
